...
The workbook contains  sheet 1: original dataset
...
step 3: The column names are re-named to ensure that they are clear and understandable.
       ...
       Age is renamed to Customer_Age
       Gender remains as Gender
       marital stat is renamed to Marital Status
       Pur Date is renamed to Purchase_Date
       Amt is renamed to Amount 
       Location remains as Location
